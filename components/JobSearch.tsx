...
const JobSearch: React.FC<JobSearchProps> = ({ skills, jobQuery, setJobQuery, onSearch, onBack }) => {
    ...
    <div className="flex flex-col items-center animate-fade-in">
      ...
      <div className="w-full max-w-lg flex flex-col sm:flex-row gap-4">
       ...
       <div className="w-full max-w-lg mt-4 flex justify-between items-center">
         <button onClick={onBack} className="text-amber-400 hover:text-amber-300 text-sm">
          &larr; Back to Resume
        </button>
      </div>
    </div>
